/**
 * Banco de preguntas por tema validado para el contexto de Chile (EUNAOD / Normativa MINSAL).
...
const BANCO_POR_TEMAS = [
  {
    ...
    nombre: 'Endodoncia',
    preguntas: [
      { id: 't1_q1', texto: '¿Cuál es el objetivo principal del hipoclorito de sodio (NaOCl) durante la irrigación endodóntica?', opciones: ['Disolver tejido orgánico y actuar como antimicrobiano', 'Eliminar únicamente el smear layer', 'Aumentar la adhesión del sellador', 'Determinar la longitud de trabajo'], correcta: 0 }, // Correcto: Capacidad solvente orgánica estándar en Chile
      { id: 't1_q2', texto: '¿Cuál es la función principal del EDTA durante la irrigación en endodoncia?', opciones: ['Disolver tejido orgánico pulpar', 'Eliminar el smear layer mediante acción quelante sobre la dentina', 'Desinfectar los conductos radiculares', 'Lubricar los instrumentos mecanizados'], correcta: 1 }, // Correcto: Acción quelante inorgánica
      { id: 't1_q3', texto: 'La longitud de trabajo en endodoncia se define como:', opciones: ['La distancia desde la cúspide hasta el ápice radiográfico', 'La distancia desde un punto de referencia coronario hasta la constricción apical', 'La distancia desde la cámara pulpar hasta el ápice anatómico', 'La distancia desde la entrada del conducto hasta el foramen apical'], correcta: 1 }, // Correcto: Límite CDC
  ...
  },
  {
    ...
    preguntas: [
      ...
      { id: 't2_q9', texto: '¿Cuál es una recomendación clínica común antes de realizar procedimientos adhesivos después de un blanqueamiento?', opciones: ['Esperar aproximadamente 1 a 2 semanas', 'Aplicar más adhesivo del habitual', 'No realizar grabado ácido', 'Utilizar únicamente resinas fluidas'], correcta: 0 }, // Estándar clínico en Chile
  ...
  },
  {
    ...
    preguntas: [
      ...
      { id: 't5_q8', texto: '¿Cuál es la frecuencia comúnmente recomendada para el mantenimiento periodontal en pacientes tratados por periodontitis?', opciones: ['Cada 6 a 12 meses', 'Cada 3 a 4 meses', 'Cada 2 años', 'Solo cuando el paciente presenta dolor'], correcta: 1 }, // Estándar de control en Chile
  ...
  },
  {
    ...
    preguntas: [
      ...
      { id: 't6_q3', texto: '¿Cuál es el principal mecanismo de acción del flúor en la prevención de caries?', opciones: ['Aumentar la permeabilidad del esmalte', 'Favorecer la desmineralización del esmalte', 'Estimular la actividad bacteriana', 'Promover la remineralización y formar fluorapatita'], correcta: 3 }, // Clave en exámenes de salud en Chile
      ...
      { id: 't6_q5', texto: '¿Cuál es la concentración aproximada de flúor más común en las pastas dentales para adultos?', opciones: ['500 ppm', '1000–1500 ppm', '2500 ppm', '5000 ppm'], correcta: 1 }, // Norma técnica chilena
  ...
  },
  {
    ...
    preguntas: [
      { id: 't10_q1', texto: '¿Cuál es el método de esterilización más utilizado en odontología para instrumental crítico?', opciones: ['Autoclave de vapor a presión', 'Radiación ultravioleta', 'Inmersión en alcohol', 'Lavado con agua destilada'], correcta: 0 }, // Norma de bioseguridad MINSAL
  ...
  },
  {
    ...
    preguntas: [
      { id: 't11_q1', texto: '¿Cuál es el medicamento de primera elección en el manejo de una anafilaxia en el consultorio odontológico?', opciones: ['Antihistamínicos orales', 'Adrenalina (epinefrina)', 'Ibuprofeno', 'Paracetamol'], correcta: 1 }, // Estándar de reanimación en Chile
      ...
      { id: 't11_q7', texto: '¿Qué medida inicial debe tomarse ante sospecha de sobredosis de anestesia local?', opciones: ['Continuar el procedimiento dental', 'Administrar más anestesia', 'Suspender el procedimiento y evaluar signos vitales', 'Indicar enjuague bucal'], correcta: 2 }, // Protocolo de seguridad
  ...
  },
  {
    ...
    preguntas: [
      ...
      { id: 't12_q7', texto: 'En una emergencia por anafilaxia, ¿cuál es la vía preferida de administración de adrenalina?', opciones: ['Intramuscular en músculo vasto lateral', 'Subcutánea en brazo', 'Intravenosa directa siempre', 'Oral en comprimidos'], correcta: 0 }, // Fundamental en Chile
  ...
  },
  {
    ...
    preguntas: [
      ...
      { id: 't13_q5', texto: 'Según la normativa sanitaria, la autoridad sanitaria regional corresponde a:', opciones: ['El Ministerio de Educación', 'Las Secretarías Regionales Ministeriales de Salud (SEREMI)', 'El Ministerio de Justicia', 'Las municipalidades exclusivamente'], correcta: 1 }, // Estructura estatal chilena
  ...
  },
  {
    ...
    preguntas: [
      ...
      { id: 't14_q2', texto: 'Según la Ley N° 19.653, el principio de probidad administrativa implica:', opciones: ['Actuar con interés personal en las decisiones públicas', 'Dar prioridad a beneficios privados', 'Observar una conducta intachable y desempeño honesto de la función pública', 'Delegar todas las decisiones en subordinados'], correcta: 2 }, // Definición Contraloría Chile
  ...
  },
  {
    ...
    nombre: 'Ley N° 18.834',
    preguntas: [
      { id: 't15_q1', texto: 'La Ley N° 18.834 corresponde al:', opciones: ['Código Sanitario', 'Estatuto Administrativo que regula a los funcionarios públicos', 'Código del Trabajo', 'Ley de Municipalidades'], correcta: 1 }, // Estatuto público chileno
      ...
      { id: 't15_q5', texto: '¿Cuál de las siguientes constituye una sanción disciplinaria contemplada en la Ley N° 18.834?', opciones: ['Ascenso automático', 'Multa o suspensión del empleo', 'Bonificación especial', 'Aumento de remuneración'], correcta: 1 }, // Sanciones en Chile
      { id: 't15_q6', texto: '¿Qué procedimiento se utiliza para investigar faltas administrativas de un funcionario?', opciones: ['Investigación sumaria o sumario administrativo', 'Juicio civil', 'Auditoría tributaria', 'Consulta popular'], correcta: 0 }, // Procedimiento disciplinario estándar
